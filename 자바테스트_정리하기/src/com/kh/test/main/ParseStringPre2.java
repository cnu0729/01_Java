...
public class ParseStringPre2 {
	public static void main(String[] args) {
		...
		System.out.println("성별 변호는 : " +성별번호);
		
		//3항연산자를 사용해서 성별변호가 1 또는 3이면 ? "남성" : "여성";
		...
		boolean is주민 = 
						...
						(주민번호4.charAt(6) == '-') && //2. 주민등록번호 생년월일작성후 - 들어가있는지
						(주민번호4.substring(0, 6).matches("[0-9]+")) && //3. 앞에 6자리가 숫자로만 이루어져 있는지
						(주민번호4.substring(7).matches("[0-9]+")); //4. 뒤에서 7번부터 모두 숫자로 이루어져 있는지
