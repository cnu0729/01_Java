...
*/	
	 ...
	 * 자식변수) { //super(부모변수); //부모변수에 어떻게 받아서 가져가겠다 라는 것이 없기 때문에 뜨는 에러 this.자식변수 =
	 * 자식변수; }
	 */
