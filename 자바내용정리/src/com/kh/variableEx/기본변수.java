...
//필드	
	//자료형 기본
		//1.숫자
			...
			short sh  = 3;
		//2.실수
			float ft = 3.14f; //기본 실수 값은 double 이고 double은 float 보다 큰 값이기 때문에
							  //뒤에 f나 F를 붙여서 작성해줘야함
		    double db = 3.14; //실수는 초기값이 double임으로 뒤에 d를 안붙여줘도 됨
	    //3.문자
		    char ch = 'A'; 	  //문자는 ''작성해줘아하고 가 A 이런 식으로 하나만 넣어야함
		//4. true false 기다 아니다
		//boolean은 기본값이 false이기때문에
